...
terraform plan -var-file="clusters/<cluster_name>/cluster_variables.tfvars"

terraform apply -var-file="clusters/<cluster_name>/cluster_variables.tfvars"

terraform destroy -var-file="clusters/<cluster_name>/cluster_variables.tfvars"
